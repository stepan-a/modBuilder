...
%   grammar; they are listed for the same skipping purpose.
        names = {'model', 'steady_state_model', 'initval', 'endval', 'histval', 'shocks', 'mshocks', ...
             'estimated_params', 'estimated_params_init', 'estimated_params_bounds', ...
             'observation_trends', 'optim_weights', 'osr_params_bounds', 'ramsey_constraints', ...
             'verbatim', 'epilogue', 'homotopy_setup', 'conditional_forecast_paths', ...
             'svar_identification', 'moment_calibration', 'irf_calibration', 'matched_moments', ...
             'occbin_constraints', 'model_replace', 'shock_groups', 'init2shocks', ...
             'filter_initial_state', 'generate_irfs', 'shock_decomposition_options', ...
             'deterministic_trends', 'estimated_params_remove', 'filter_tunes', ...
             'heteroskedastic_shocks', 'matched_irfs', 'matched_irfs_weights', 'pac_target_info', ...
             'perfect_foresight_controlled_paths', 'priors', 'shock_paths'};
end
