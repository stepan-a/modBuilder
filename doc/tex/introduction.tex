...
Add a "name" tag to these:
  ...
  they are. Most of the rest hit a refused statement or an operator the parser does not
  know yet (\texttt{$\perp$}); a few expect a macro variable that Dynare's test runner
  sets with \texttt{-D}, and load once \texttt{Defines=} sets it.
