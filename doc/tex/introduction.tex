...
\begin{frame}[fragile]
  ...
  Each possible pair is given a price: one or two by the case, a discount for the
  left-hand side, a small surcharge when many equations want the same variable. Leaving an
