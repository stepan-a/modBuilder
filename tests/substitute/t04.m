...
% Test substitute method: implicit loop with explicit equation names using regex
...
% Substitute alpha_$1 with gamma_$1 in equation Y (not in C) using regex
m.substitute('alpha_$1', 'gamma_$1', 'Y', {1, 2});
