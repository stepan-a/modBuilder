...
% Test substitute method: backward compatibility (regex substitution)
...
% Substitute alpha with gamma in equation y using regex
...
% Check that gamma is now a parameter (rename was used)
