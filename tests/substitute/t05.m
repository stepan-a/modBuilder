...
% Test substitute method: implicit loop with indexed equations using regex (Cartesian product with warnings)
...
% Substitute alpha_$1 with beta_$1 in equations Y_$1 using regex
...
Countries = {'FR', 'DE'};
m.substitute('alpha_$1', 'beta_$1', 'Y_$1', Countries);
