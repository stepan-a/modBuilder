...
% Test substitute method: implicit loop - substitute in all equations with regex
...
% Substitute alpha_$1 with beta_$1 in all equations using implicit loop and regex
m.substitute('alpha_$1', 'beta_$1', {1, 2, 3});
