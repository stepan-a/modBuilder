...
model.parameter('tau', 0.025, 'texname', '\tau');
...
model.exogenous('e', 0, 'long_name', 'Productivity shock innovation');
model.exogenous('u', 0, 'long_name', 'Preference shock innovation');
...
b = modiff('rbc11.mod', 'rbc11.true.mod');
